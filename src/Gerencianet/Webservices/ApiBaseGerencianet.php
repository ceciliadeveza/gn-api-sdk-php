...
use Gerencianet\Helpers\GerencianetException;
 ...
 * @package Gerencianet
 */
abstract class ApiBaseGerencianet {
   ...
   *
   * @return ApiBaseGerencianet An instance of ApiBaseGerencianet
   */
  public function run() {
    $this->mapData();
